...
class TheControl:
    def __init__(self):
        ...
        self.CRTline = ""
        for x in range(240):
            self.CRTline = self.CRTline + "."
        # CRTline = "........................................"
        # self.CRT = [(CRTline), (CRTline), (CRTline), (CRTline), (CRTline), (CRTline)]
    ...
    # ******************************************************************************
    # * @brief Print the image in the CRT
    # ******************************************************************************
    def printImageCRT(self):
        print(self.CRTline[0:40], flush=True)
        print(self.CRTline[40:80], flush=True)
        print(self.CRTline[80:120], flush=True)
        print(self.CRTline[120:160], flush=True)
        print(self.CRTline[160:200], flush=True)
        print(self.CRTline[200:240], flush=True)    

    # ******************************************************************************
    # * @brief Draw the sprites according to the position of the pixel
    # ******************************************************************************
    def processImageCRT(self):
        pixelPosition = self.cycles % 40
        if(pixelPosition >= self.xRegister-1 and pixelPosition <= self.xRegister+1):
            self.CRTline = self.CRTline[:self.cycles] + "#" + self.CRTline[self.cycles + 1:]
